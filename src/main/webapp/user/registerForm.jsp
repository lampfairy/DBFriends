		...
		<form name="form" method="POST" action="<c:url value='/user/register' />">
		    ...
		    <table>
			  ...
			  <tr>
				...
				<td width="250">
					<input type="radio" name="bankName" value="국민"
			...
			<div class = "btnBox">
				<input type="submit" value="회원 가입" onClick="return userCreate()" class = "btn"> &nbsp;
			</div>
		</form>
	</div>
</body>
